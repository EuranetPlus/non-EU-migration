export const config = {
	mapTitle: 'non-EU-migration', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://non-eu-migration.vercel.app/', // The url provided when deploying the map on Vercel
